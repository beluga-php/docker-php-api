...
class Client extends Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? Model\ContainerSummaryItem[]|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @return ($fetch is 'object' ? Model\ContainersCreatePostResponse201|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     * @throws Exception\ContainerLogsInternalServerErrorException
     *
     ...
     *
     * @return ($fetch is 'object' ? Model\ContainersIdChangesGetResponse200Item[]|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @return ($fetch is 'object' ? Model\ContainersIdWaitPostResponse200|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @return ($fetch is 'object' ? Model\Image|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @return ($fetch is 'object' ? Model\EventsGetResponse200|null : \Psr\Http\Message\ResponseInterface)
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\SystemDataUsage($accept), $fetch);
    }
    ...
    {
        return $this->executeEndpoint(new Endpoint\ExecStart($id, $requestBody), $fetch);
    }
     ...
     *
     * @return ($fetch is 'object' ? Model\VolumesGetResponse200|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @return ($fetch is 'object' ? Model\PluginsPrivilegesGetJsonResponse200Item[]|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @param Model\PluginsPullPostBodyItem[]|null $requestBody
     * @param array{
    ...
    {
        return $this->executeEndpoint(new Endpoint\PluginDisable($name, $accept), $fetch);
    }

    /**
     * @param string                                      $name        The name of the plugin. The `:latest` tag is optional, and is the
     *                                                                 default if omitted.
     * @param Model\PluginsNameUpgradePostBodyItem[]|null $requestBody
     * @param array{
     ...
     *
     * @return ($fetch is 'object' ? Model\ServicesCreatePostResponse201|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     * @throws Exception\ServiceLogsInternalServerErrorException
     * @throws Exception\ServiceLogsServiceUnavailableException
     *
     * @return ($fetch is 'object' ? string|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     * @throws Exception\TaskLogsInternalServerErrorException
     * @throws Exception\TaskLogsServiceUnavailableException
     *
     * @return ($fetch is 'object' ? string|null : \Psr\Http\Message\ResponseInterface)
     */
     ...
     *
     * @return ($fetch is 'object' ? Model\DistributionNameJsonGetResponse200|null : \Psr\Http\Message\ResponseInterface)
     */
