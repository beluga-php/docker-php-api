...
class PluginsPrivilegesGetJsonResponse200ItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Docker\API\Model\PluginsPrivilegesGetJsonResponse200Item::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Docker\API\Model\PluginsPrivilegesGetJsonResponse200Item::class === $data::class;
    }
    ...
    {
        return [\Docker\API\Model\PluginsPrivilegesGetJsonResponse200Item::class => false];
    }
}
