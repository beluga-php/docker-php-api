...
class TopologyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Docker\API\Model\Topology::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Docker\API\Model\Topology::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Docker\API\Model\Topology();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('segments') && null !== $data->getSegments()) {
            $values = new \Docker\API\Runtime\JsonObject();
            foreach ($data->getSegments() as $key => $value) {
                $values[$key] = $value;
            }
    ...
    {
        return [\Docker\API\Model\Topology::class => false];
    }
}
