...
class ServiceSpecModeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('global') && null !== $data->getGlobal()) {
            $dataArray['Global'] = null === $data->getGlobal() ? null : new \Docker\API\Runtime\JsonObject($this->normalizer->normalize($data->getGlobal(), 'json', $context));
        }
        ...
        if ($data->isInitialized('globalJob') && null !== $data->getGlobalJob()) {
            $dataArray['GlobalJob'] = null === $data->getGlobalJob() ? null : new \Docker\API\Runtime\JsonObject($this->normalizer->normalize($data->getGlobalJob(), 'json', $context));
        }
