...
class ContainersIdArchiveHeadJsonResponse400Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Docker\API\Model\ContainersIdArchiveHeadJsonResponse400::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Docker\API\Model\ContainersIdArchiveHeadJsonResponse400::class === $data::class;
    }
    ...
    {
        return [\Docker\API\Model\ContainersIdArchiveHeadJsonResponse400::class => false];
    }
}
