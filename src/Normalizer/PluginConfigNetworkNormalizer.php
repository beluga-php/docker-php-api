...
class PluginConfigNetworkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Docker\API\Model\PluginConfigNetwork::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Docker\API\Model\PluginConfigNetwork::class === $data::class;
    }
    ...
    {
        return [\Docker\API\Model\PluginConfigNetwork::class => false];
    }
}
