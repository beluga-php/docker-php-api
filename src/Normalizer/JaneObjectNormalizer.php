...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    protected $normalizers = [
        ...
        \Docker\API\Model\Image::class => ImageNormalizer::class,

        \Docker\API\Model\ImageRootFS::class => ImageRootFSNormalizer::class,

        \Docker\API\Model\ImageMetadata::class => ImageMetadataNormalizer::class,
        ...
        \Docker\API\Model\TaskSpecPluginSpecPluginPrivilegeItem::class => TaskSpecPluginSpecPluginPrivilegeItemNormalizer::class,
        ...
        \Docker\API\Model\ContainerSummaryItem::class => ContainerSummaryItemNormalizer::class,

        \Docker\API\Model\ContainerSummaryItemHostConfig::class => ContainerSummaryItemHostConfigNormalizer::class,

        \Docker\API\Model\ContainerSummaryItemNetworkSettings::class => ContainerSummaryItemNetworkSettingsNormalizer::class,
        ...
        \Docker\API\Model\ContainersCreatePostResponse201::class => ContainersCreatePostResponse201Normalizer::class,
        ...
        \Docker\API\Model\ContainersIdWaitPostResponse200::class => ContainersIdWaitPostResponse200Normalizer::class,

        \Docker\API\Model\ContainersIdWaitPostResponse200Error::class => ContainersIdWaitPostResponse200ErrorNormalizer::class,

        \Docker\API\Model\ContainersIdArchiveGetResponse400::class => ContainersIdArchiveGetResponse400Normalizer::class,

        \Docker\API\Model\ContainersIdArchiveHeadJsonResponse400::class => ContainersIdArchiveHeadJsonResponse400Normalizer::class,

        \Docker\API\Model\ContainersIdArchiveHeadTextplainResponse400::class => ContainersIdArchiveHeadTextplainResponse400Normalizer::class,
        ...
        \Docker\API\Model\EventsGetResponse200::class => EventsGetResponse200Normalizer::class,

        \Docker\API\Model\EventsGetResponse200Actor::class => EventsGetResponse200ActorNormalizer::class,
        ...
        \Docker\API\Model\VolumesGetResponse200::class => VolumesGetResponse200Normalizer::class,

        \Docker\API\Model\VolumesCreatePostBody::class => VolumesCreatePostBodyNormalizer::class,
        ...
        \Docker\API\Model\PluginsPrivilegesGetJsonResponse200Item::class => PluginsPrivilegesGetJsonResponse200ItemNormalizer::class,

        \Docker\API\Model\PluginsPrivilegesGetTextplainResponse200Item::class => PluginsPrivilegesGetTextplainResponse200ItemNormalizer::class,

        \Docker\API\Model\PluginsPullPostBodyItem::class => PluginsPullPostBodyItemNormalizer::class,

        \Docker\API\Model\PluginsNameUpgradePostBodyItem::class => PluginsNameUpgradePostBodyItemNormalizer::class,
        ...
        \Docker\API\Model\DistributionNameJsonGetResponse200::class => DistributionNameJsonGetResponse200Normalizer::class,

        \Docker\API\Model\DistributionNameJsonGetResponse200Descriptor::class => DistributionNameJsonGetResponse200DescriptorNormalizer::class,

        \Docker\API\Model\DistributionNameJsonGetResponse200PlatformsItem::class => DistributionNameJsonGetResponse200PlatformsItemNormalizer::class,
