...
class TaskSpecContainerSpecPrivilegesAppArmorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Docker\API\Model\TaskSpecContainerSpecPrivilegesAppArmor::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Docker\API\Model\TaskSpecContainerSpecPrivilegesAppArmor::class === $data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Docker\API\Model\TaskSpecContainerSpecPrivilegesAppArmor();
    ...
    {
        return [\Docker\API\Model\TaskSpecContainerSpecPrivilegesAppArmor::class => false];
    }
}
