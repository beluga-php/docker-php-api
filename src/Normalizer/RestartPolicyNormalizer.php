...
class RestartPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Docker\API\Model\RestartPolicy::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Docker\API\Model\RestartPolicy::class === $data::class;
    }
    ...
    {
        return [\Docker\API\Model\RestartPolicy::class => false];
    }
}
