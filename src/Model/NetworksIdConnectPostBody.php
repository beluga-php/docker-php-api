...
class NetworksIdConnectPostBody implements AdditionalPropertiesInterface
{
    ...
    {
        return ['container' => ['Container', 'getContainer', 'setContainer'], 'endpointConfig' => ['EndpointConfig', 'getEndpointConfig', 'setEndpointConfig']];
    }
}
