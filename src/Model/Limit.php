...
class Limit implements AdditionalPropertiesInterface
{
    ...
    {
        return ['nanoCPUs' => ['NanoCPUs', 'getNanoCPUs', 'setNanoCPUs'], 'memoryBytes' => ['MemoryBytes', 'getMemoryBytes', 'setMemoryBytes'], 'pids' => ['Pids', 'getPids', 'setPids']];
    }
}
